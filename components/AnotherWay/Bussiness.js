...
const Bussiness = (props) => {
  ...
  console.log("Bussiness data", data)
  ...
  return (
    <View>
      <Text style={styles.text}>Bussiness - News</Text>
      <ScrollView>
        {data.map((item, index) => {
          // const imageUrl = item.urlToImage
          //   ? item.urlToImage
          //   : 'https://platform.theverge.com/wp-content/uploads/sites/2/2025/05/acastro_STK057_02.jpg';
